...
const cost = (value) => value == null ? "$0" : value < .001 ? `$${value.toFixed(5)}` : `$${value.toFixed(4)}`;
...
export default function ReasoningDiff({ drawer }) {
  ...
  return (
    <section className="reasoning-card card" aria-labelledby="reasoning-title">
